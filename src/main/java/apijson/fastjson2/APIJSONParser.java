 ...
 * @author Lemon
 */
public class APIJSONParser<T> extends apijson.framework.APIJSONParser<T, JSONObject, JSONArray> {
	...
	@Override
	public apijson.framework.APIJSONParser<T, JSONObject, JSONArray> createParser() {
		return APIJSONApplication.createParser();
	}
	@Override
	public apijson.framework.APIJSONFunctionParser<T, JSONObject, JSONArray> createFunctionParser() {
		return APIJSONApplication.createFunctionParser();
	}
	
	@SuppressWarnings("unchecked")
	@Override
	public apijson.framework.APIJSONVerifier<T, JSONObject, JSONArray> createVerifier() {
		return APIJSONApplication.createVerifier();
	}
	
	@Override
	public apijson.framework.APIJSONSQLConfig<T, JSONObject, JSONArray> createSQLConfig() {
		return APIJSONApplication.createSQLConfig();
	}
	@Override
	public apijson.framework.APIJSONSQLExecutor<T, JSONObject, JSONArray> createSQLExecutor() {
